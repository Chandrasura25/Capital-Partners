...
const Invest = () => {
  return (
    <motion.section id="invest" className={investStyles.container}>
      <motion.div>
        <motion.h2 variants={textVariant()} className={investStyles.titleText}>WHY YOU SHOULD <span>INVEST WITH US</span></motion.h2>
        ...
        <motion.p className={investStyles.top} variants={fadeIn("up", "spring", 0.5, 0.75)}>
